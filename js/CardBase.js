export default class CardBase extends Phaser.GameObjects.Container {
    constructor(data){
        ...
        let textName = new Phaser.GameObjects.BitmapText(scene, 0, 0, 'pressstart', name, 11, Phaser.GameObjects.BitmapText.ALIGN_CENTER);
    ...
    set cardname(newName) {
        ...
        this.textName.y = 60 - this.textName.height;
    }
}